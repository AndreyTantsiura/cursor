...
document.writeln(`Функція №1: ${getMaxDigit(1236)}`);
...
document.writeln(`Функція №2: ${numberInPow(2, 3)}`);
...
document.writeln(`Функція №3: ${transformName("aNDriY")}`);
...
document.writeln(`Функція №4: ${salaryWithoutTax(3000)}`);
...
document.writeln(`Функція №6: ${countLetter("Асталавіста", "а")}`);
